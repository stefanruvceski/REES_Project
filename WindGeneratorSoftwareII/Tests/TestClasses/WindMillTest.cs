...
namespace Tests.TestClasses
{
    ...
    public class WindMillTest
    {
        ...
        public void WindMillConstructor_GoodParameters(double coefficient, double minPower, double turbineDiameter, double maxSpeed, int maxSpeedTime)
        {
            WindMill windMill = new WindMill(coefficient, minPower, turbineDiameter, maxSpeed, maxSpeedTime);
        ...
        public void WindMillConstructor_BorderParameters(double coefficient, double minPower, double turbineDiameter, double maxSpeed, int maxSpeedTime)
        {
            WindMill windMill = new WindMill(coefficient, minPower, turbineDiameter, maxSpeed, maxSpeedTime);
        ...
        public void WindMillConstructor_BadParameters(double coefficient, double minPower, double turbineDiameter, double maxSpeed, int maxSpeedTime)
        {
            WindMill windMill = new WindMill(coefficient, minPower, turbineDiameter, maxSpeed, maxSpeedTime);
