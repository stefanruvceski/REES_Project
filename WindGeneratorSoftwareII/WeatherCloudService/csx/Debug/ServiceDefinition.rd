...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="WeatherCloudService" generation="1" functional="0" release="0" Id="a2575c2e-b262-42d5-9804-70030bb8d5c2" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
  ...
  <implements>
    <implementation Id="d4cb9cb1-4c69-4ee6-9ff3-449585edbf66" ref="Microsoft.RedDog.Contract\ServiceContract\WeatherCloudServiceContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="ff8e7a2a-d2c8-44e9-aa02-90772347a158" ref="Microsoft.RedDog.Contract\Interface\WeatherWebRole:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/WeatherCloudService/WeatherCloudServiceGroup/WeatherWebRole:Endpoint1" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="08344cb2-2b61-4444-bdfd-b4bc0505d4d3" ref="Microsoft.RedDog.Contract\Interface\WeatherWorkerRole:InputRequest@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/WeatherCloudService/WeatherCloudServiceGroup/WeatherWorkerRole:InputRequest" />
          </inPort>
        </interfaceReference>
